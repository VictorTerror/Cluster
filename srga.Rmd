...
dados20 <- import("obito_srag20.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
evolucao20 <- import("obito_srag20.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
evolucao_final[order(evolucao.k5$cluster, decreasing = TRUE),]
...
dados21 <- import("obito_srag21.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
evolucao21 <- import("obito_srag21.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
dados22 <- import("obito_srag22.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
evolucao22 <- import("obito_srag22.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
