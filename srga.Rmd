---
title: "Agrupamentos dos Estabelecimentos de Internação registrados no TABNET, São Paulo, biênio 2020/2021, de acordo com a evolução da Covid19 Síndrome Respiratória Aguda Grave"
author: 
    - name: "**Prevent Senior**"
...
Este relatório tem por objetivo agrupar os estabelecimentos de internação registrados na Secretaria Municipal de Sáude de São Paulo em relação à evolução dos pacientes no que diz respeito à Covid-19 com diagnóstico de Síndrome Respiratória Aguda Grave (SRAG), nos anos de 2020 e 2021. 
...
dados20 <- import("~/SGQ/covid_sp/obito_srag20.csv", header = TRUE, na.rm = TRUE)
...
evolucao2 <- import("~/SGQ/covid_sp/obito_srag20.csv", header = TRUE, na.rm = TRUE)
