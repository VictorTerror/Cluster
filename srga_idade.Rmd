...
dados20 <- import("idade_srag20.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100) 
...
idade20 <- import("idade_srag20.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
dados21 <- import("idade_srag21.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100) 
...
idade22 <- import("idade_srag21.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
...
dados22 <- import("idade_srag22.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100) 
...
idade22 <- import("idade_srag22.csv", header = TRUE, na.rm = TRUE) |> 
  filter(total >= 100)
